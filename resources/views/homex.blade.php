...
<section id="carousel">
    <div id="first-carousel" class=" carousel slide " data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <img class="sliderImage" src="{{ asset('homepage/img/car6.jpg') }}" width="1400" height="500">
        </div>

        <div class="carousel-item">
            <img src="{{ asset('homepage/img/car1.jpg') }}" width="1400" height="500">
        </div>

        <div class="carousel-item">
            <img src="{{ asset('homepage/img/car2.jpg') }}" width="1400" height="500">
        </div>

        <div class="carousel-item">
            <img src="{{ asset('homepage/img/car3.jpg') }}" width="1400" height="500">
        </div>

        <div class="carousel-item">
            <img src="{{ asset('homepage/img/car4.jpg') }}" width="1400" height="500">
        </div>

        <div class="carousel-item">
            <img src="{{ asset('homepage/img/car5.jpg') }}" width="1400" height="500">
        </div>
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="caption">
                        ...
                        <p>منظمة مصرية أهلية، غير حكومية، لا تهدف إلى الربح ولا تخضع لضرائب على التبرعات،
                            أنشئت عام 1993 مقيدة برقم 803 مركزية بوزارة التضامن الاجتماعي، تهدف إلى خدمة الفئات الأكثر
                            احتياجًا،
                            دون أي تمييز ديني أو سياسي، وذلك بشكل مؤسسي متطور ويؤكد دور العمل الأهلي فى تنمية المجتمعات
...
<section id="gallery">
        ...
        <div class="container-flex">
            <div class="row">
              ...
              <img class="img-fluid" src="{{ asset('homepage/img/gr1.jpg') }}">
          </div>
      </div>
      <div class="col-md-6 col-sm-12">
        <div class="img-container">
            <img class="img-fluid" src="{{ asset('homepage/img/gr2.jpg') }}">
        </div>
    </div> 
    <div class="col-md-6 col-sm-12">
        <div class="img-container">
            <img class="img-fluid" src="{{ asset('homepage/img/gr3.jpg') }}">
        </div>
    </div> 
   <div class="col-md-6 col-sm-12">
                    <div class="img-container">
                        <div class="gal-cont">
                            <a class="effect1" href=" {{ route('galleryz') }}">
                              عرض المزيد
                              <span class="bg"></span>
                            </a>
                          </div>
